  ...
  */
  ...
  export interface itemsDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'items'> extends True ? CheckSelect<T, Prisma__itemsClient<items>, Prisma__itemsClient<itemsGetPayload<T>>> : CheckSelect<T, Prisma__itemsClient<items | null, null>, Prisma__itemsClient<itemsGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'items'> extends True ? CheckSelect<T, Prisma__itemsClient<items>, Prisma__itemsClient<itemsGetPayload<T>>> : CheckSelect<T, Prisma__itemsClient<items | null, null>, Prisma__itemsClient<itemsGetPayload<T> | null, null>>
     ...
     * const itemsWithNameOnly = await prisma.items.findMany({ select: { name: true } })
     * 
    **/
